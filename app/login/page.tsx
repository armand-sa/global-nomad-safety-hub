...
import { Loader2, AlertCircle, Wifi, WifiOff, CheckCircle2, Eye, EyeOff } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="container max-w-screen-xl mx-auto px-4 flex min-h-screen pt-16 pb-20 flex-col items-center justify-center">
